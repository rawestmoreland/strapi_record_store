...
export async function getServerSideProps({ params, query }) {
  ...
  const genreResponse = await axios.get(`${process.env.STRAPI_API_URL}/genres${genreQuery ? `?${genreQuery}` : ''}`, {
    headers: {
...
export default function Page({ initialAlbums, genre, initialPagination, initialHasMore }) {
