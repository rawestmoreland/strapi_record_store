...
export async function getServerSideProps({ params }) {
  ...
  try {
    const albumResponse = await axios.get(`${process.env.STRAPI_API_URL}/products/${id}?populate=*`, {
      headers: {
        Authorization: `Bearer ${process.env.STRAPI_API_TOKEN}`,
      },
    });

    return { props: { album: albumResponse.data.data } };
  } catch (error) {
    return { props: {} };
  }
}
          ...
          <div className="lg:max-w-lg lg:self-end">
            ...
            <section aria-labelledby="information-heading" className="mt-4">
              ...
              <div className="flex items-center">
                <p className="text-lg text-gray-900 sm:text-xl">{currency(sellPrice).format()}</p>
